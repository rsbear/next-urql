...
var withUrqlClient = function withUrqlClient(App) {
  var withUrql = function withUrql(props) {
    ...
    var urqlClient = react__WEBPACK_IMPORTED_MODULE_11___default.a.useMemo(function () {
      return props.urqlClient || Object(_initUrql__WEBPACK_IMPORTED_MODULE_15__["default"])(props.urqlState, props.serverAccessToken)[0];
    }, []);
    return __jsx(urql__WEBPACK_IMPORTED_MODULE_12__["Provider"], {
      ...
      authUser: !fetching && data && data.me,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 22
      },
...
//# sourceMappingURL=index.js.b3a70ddc28eaab341a9f.hot-update.js.map